...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#" onclick="return clicked(this);">Adaptive Demo</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="#" onclick="return clicked(this);">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" onclick="return clicked(this);">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" onclick="return clicked(this);">Services</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" onclick="return clicked(this);">Contact</a>
            </li>
          </ul>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <a href="#" onclick="return clicked(this);">Web Design</a>
                    </li>
                    <li>
                      <a href="#" onclick="return clicked(this);">HTML</a>
                    </li>
                    <li>
                      <a href="#" onclick="return clicked(this);">Freebies</a>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <a href="#" onclick="return clicked(this);">JavaScript</a>
                    </li>
                    <li>
                      <a href="#" onclick="return clicked(this);">CSS</a>
                    </li>
                    <li>
                      <a href="#" onclick="return clicked(this);">Tutorials</a>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Adaptive</p>
      </div>
      <!-- /.container -->
    </footer>
